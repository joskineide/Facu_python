...
a = str(random.sample(alphabet["a"], k=1))
b = str(random.sample(alphabet["b"], k=1))
c = str(random.sample(alphabet["c"], k=1))
d = str(random.sample(alphabet["d"], k=1))
e = str(random.sample(alphabet["e"], k=1))
f = str(random.sample(alphabet["f"], k=1))
g = str(random.sample(alphabet["g"], k=1))
h = str(random.sample(alphabet["h"], k=1))
i = str(random.sample(alphabet["i"], k=1))
j = str(random.sample(alphabet["j"], k=1))
k = str(random.sample(alphabet["k"], k=1))
l = str(random.sample(alphabet["l"], k=1))
m = str(random.sample(alphabet["m"], k=1))
n = str(random.sample(alphabet["n"], k=1))
o = str(random.sample(alphabet["o"], k=1))
p = str(random.sample(alphabet["p"], k=1))
q = str(random.sample(alphabet["q"], k=1))
r = str(random.sample(alphabet["r"], k=1))
s = str(random.sample(alphabet["s"], k=1))
t = str(random.sample(alphabet["t"], k=1))
u = str(random.sample(alphabet["u"], k=1))
v = str(random.sample(alphabet["v"], k=1))
w = str(random.sample(alphabet["w"], k=1))
x = str(random.sample(alphabet["x"], k=1))
y = str(random.sample(alphabet["y"], k=1))
z = str(random.sample(alphabet["z"], k=1))
text = text.replace("a", a[2:3])
text = text.replace("b", b[2:3])
text = text.replace("c", c[2:3])
text = text.replace("d", d[2:4])
text = text.replace("e", e[2:3])
text = text.replace("f", f[2:4])
text = text.replace("g", g[2:3])
text = text.replace("h", h[2:5])
text = text.replace("i", i[2:3])
text = text.replace("j", j[2:4])
text = text.replace("k", k[2:4])
text = text.replace("l", l[2:4])
text = text.replace("m", m[2:5])
text = text.replace("n", n[2:5])
text = text.replace("o", o[2:3])
text = text.replace("p", p[2:4])
text = text.replace("q", q[2:3])
text = text.replace("r", r[2:4])
text = text.replace("s", s[2:3])
text = text.replace("t", t[2:5])
text = text.replace("u", u[2:5])
text = text.replace("v", v[2:3])
text = text.replace("w", w[2:5])
text = text.replace("x", x[2:4])
text = text.replace("y", y[2:3])
text = text.replace("z", z[2:3])
